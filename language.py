...
def generate_word(consonants, vowels, min_root_length=1, max_root_length=2):
...
profanity_male_first_name_suffixes = ["fart", "dam", "dik", "kok", "hole", "me", "fuk", "shit", "ass", "piss"]
profanity_female_first_name_suffixes = ["fart", "dam", "bich", "kunt", "hole", "me", "fuk", "shit", "ass", "piss"]
profanity_male_last_name_suffixes = ["fart", "dam", "dik", "kok", "hole", "fuk", "shit", "ass", "piss"]
...
if len(sys.argv) > 1:
  ...
  if arg == '-debug':
    for n in range(10):
      first_name = generate_word(consonants, vowels)
      last_name = generate_name_with_suffix(consonants, vowels, last_name_suffixes)
